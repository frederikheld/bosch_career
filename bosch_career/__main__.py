...
def main (argv=sys.argv[1:]):
    ...
    for opt, arg in opts:
        if opt in ["-h", "-?", "--help"]:
            ...
            print("")
            print("This is your chance to hijack some lousy competitor's failed PR stunt! This is")
            print("project is open for contributions. Send a PR with your companies name and")
            print("contact for applications and you might be mentioned here in the next release!")
            print("")
            print("Bosch HR!")
            print("")
            ...
            print("naively promoting it calling yourself a respectable software company.")
